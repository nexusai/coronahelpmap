    ...
    .add({
      ...
      message: {
        ...
        html:
          ...
          form.address.value +
          "<br><br>" +
          form.typeOfHelp.value +
          '<br><br><tbody><tr><td align="center" bgcolor="#000000" class="inner-td" style="border-radius:6px; font-size:16px; text-align:left; background-color:inherit;"><a href=mailto:' +
          form.contactInfo.value +
